...
def init_chatbot():
    ...
    loader = TextLoader("chatbotdata.txt")  # Replace path as needed
    docs = loader.load()
    ...
    chat = ChatOpenAI(openai_api_key="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")
    template = """You are a University support bot. Use the given context to answer students' queries. If the question is completely unrelated to college-related enquiries, please ask the user to only ask college-specific questions.
    {context}
    Question: {question}
    Helpful Answer: """
